...
<html>
  <head>
    ...
    <!-- orion icons-->
    <link rel="stylesheet" href="{{asset('adminAssets/css/orionicons.css')}}">
    <!-- theme stylesheet-->
  ...
  <body>
        ...
        <div class="row align-items-center py-5">
          ...
          <div class="col-lg-5 px-lg-4">
            ...
            <form id="loginForm" action="index.html" class="mt-4">
              ...
              <div class="form-group mb-4">
                <input type="text" name="phone" placeholder="Phone Number" class="form-control border-0 shadow form-control-lg">
              </div>
              <div class="form-group mb-4">
                <input type="text" name="password" placeholder="Password" class="form-control border-0 shadow form-control-lg">
              </div>
              <div class="form-group mb-4">
                <input type="password" name="passowrd" placeholder="Confirm Password" class="form-control border-0 shadow form-control-lg text-violet">
              </div>
              <div class="form-group mb-4">
    ...
    <script src="{{asset('adminAssets/vendor/popper.js/umd/popper.min.js')}}"> </script>
    <script src="{{asset('adminAssets/vendor/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('adminAssets/vendor/jquery.cookie/jquery.cookie.js')}}"> </script>
